...
` + data.errors.map((e) => ` - ${e.message}`).join("\n");
    ...
    function graphql2(request2, query, options) {
      ...
      return request2(requestOptions).then((response) => {
        if (response.data.errors) {
          ...
          throw new GraphqlResponseError3(requestOptions, headers, response.data);
        }
    ...
    exports.GraphqlResponseError = GraphqlResponseError3;
...
var getProjectId = async () => {
  ...
  try {
    await graphqlWithAuth(query, {
      login: (0, import_core.getInput)("project-owner"),
      projectNumber: Number((0, import_core.getInput)("project-number"))
    });
  } catch (error) {
    if (error instanceof import_graphql.GraphqlResponseError) {
      ...
      return ((_b = (_a = error.data.user) == null ? void 0 : _a.projectNext) == null ? void 0 : _b.id) || ((_d = (_c = error.data.organization) == null ? void 0 : _c.projectNext) == null ? void 0 : _d.id) || "";
    }
  }
};
...
var addProjects = async (projectNodeId) => {
  ...
  try {
    const result = await graphqlWithAuth(mutation, {
      ...
      contentId: (0, import_core2.getInput)("content-id")
    });
    return (_b = (_a = result == null ? void 0 : result.addProjectNextItem) == null ? void 0 : _a.projectNextItem) == null ? void 0 : _b.id;
  } catch (error) {
    if (error instanceof import_graphql2.GraphqlResponseError && !error.data) {
      console.error("Request failed: ", error.request);
      console.error(error.message);
    }
  }
